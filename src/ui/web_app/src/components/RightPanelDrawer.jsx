import { Brain, Terminal, FileText, Copy, Check, ChevronDown, ChevronUp, Layers, X } from 'lucide-react';
import { phaseLabel } from '../utils';

// Preserves the exact 3-tab debug/audit surface from the original always-visible
// .details-panel — only the outer container gained open/close chrome (isOpen,
// a close button, and a backdrop). Tab content, expand/collapse state, and the
// Markdown export are unchanged.
